...
namespace DiamondBilliards.PoolTime.Presentation
{
    public partial class AppForm : Form
    {
        ...
        private void AppForm_Load( object sender, EventArgs e )
        {
            ...
            if ( _isNewUpdate )
            {
                string newUpdateUrl = "http://pooltime.us/2010/06/version-1-0-0-0/";
                WebBrowserForm webBrowserForm = new WebBrowserForm( newUpdateUrl, "Version " + _appVersion );
        ...
        // open website for this application in new browser
        private void poolTimeWebsiteToolStripMenuItem_Click( object sender, EventArgs e )
        {
        ...
        // open support website for this application in new browser window
